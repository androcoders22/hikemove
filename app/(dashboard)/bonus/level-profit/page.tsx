...
import { TrendingUp, Search, Filter, Calendar, Layers } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
...
export default function LevelProfitBonus() {
  const [bonusData] = useState<LevelProfitRow[]>([
    {
      srNo: 1,
      memberId: "HM123456",
      memberName: "John Doe",
  ...
  const filteredData = useMemo(() => {
    ...
    return bonusData.filter((row) => {
      return (
        ...
        row.levelNo.toString().includes(query) ||
