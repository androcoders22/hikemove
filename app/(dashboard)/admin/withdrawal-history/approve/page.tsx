...
import { CheckCircle2, Search, Filter, History } from "lucide-react";
import {
    Table,
    TableBody,
    TableCell,
    ...
    const fetchHistory = async () => {
        ...
        try {
            ...
            if (res.data?.status && res.data?.data) {
                // Filter only approved/paid requests
                ...
                <Card className="border-border shadow-md overflow-hidden bg-white/80 backdrop-blur-md border-[#d8e5d0]">
                    <CardHeader className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 border-b bg-gray-50/50">
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-muted-foreground font-medium">Historical record of all approved and finalized withdrawal requests.</p>
                        </div>
                        <div className="flex flex-wrap items-center gap-3">
                            <div className="relative group">
                                ...
                                <Input
                                    ...
                                    className="pl-10 h-10 w-[300px] bg-white border-[#d8e5d0] rounded-lg shadow-sm focus:ring-2 focus:ring-emerald-500/20 transition-all"
                                />
                            </div>
                            <Button variant="outline" size="sm" className="h-10 border-[#d8e5d0] bg-white hover:bg-emerald-500/5 hover:text-emerald-600 px-4 font-bold rounded-lg transition-all">
                        ...
                        <div className="overflow-x-auto">
                            {isLoading ? (
                                <div className="p-12 text-center text-muted-foreground">
                                    <div className="animate-spin h-6 w-6 border-b-2 border-emerald-600 rounded-full mx-auto mb-4"></div>
                                ...
                                <Table>
                                    <TableHeader className="bg-white border-b border-[#d8e5d0]">
                                    ...
                                    <TableBody>
                                        {filteredData.map((row, index) => {
                                            ...
                                            return (
                                                <TableRow
                                                    key={row._id}
                                                    className="hover:bg-emerald-50/30 transition-colors border-b"
                                                >
                                                    ...
                                                    <TableCell className="text-sm font-bold text-emerald-600 py-3 px-4">
                                                    ...
                                                    <TableCell className="py-3 px-4 text-right">
                                                        <Badge className="bg-emerald-100 text-emerald-700 hover:bg-emerald-200 border-emerald-200 shadow-none font-bold">
